...
export default class CartSummaryItem extends React.Component {
  render() {
    return (
      <div className='col-10 my-3 mx-3 pt-3 d-flex align-items-center card row flex-wrap card-cart'>
        ...
        <div className='card-body d-flex flex-column card-body-cart'>
          ...
          <div className='cart-product-short-description'>{this.props.item.shortDescription}</div>
        </div>
      </div>
    );
  }
